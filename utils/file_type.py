...
class FileTypeClassifier(BaseComponent):
    ...
    def __init__(self, supported_types: List[str] = DEFAULT_TYPES):
        ...
        :param supported_types: The file types that this node can distinguish between.
             The default values are: `json`, `md`.
...
if __name__ == "__main__":
    files = ["/Users/phongnt/FTECH/knowledge-retrieval/test.json"]
    file_classifier = FileTypeClassifier()
    print(file_classifier.run_batch(file_paths=files))