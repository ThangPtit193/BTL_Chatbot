...
Python is the main dynamic language used at Ftech. This style guide is a list
of *dos and don'ts* for Python programs.

To help you format code correctly, we use [pylint](https://pypi.org/project/pylint/) to check conventions and codestyle

To meet PEP8 or PEP576 requirements, you could use [yapf](https://github.com/google/yapf/)
auto-formatter to avoid arguing over formatting. Optionally, you can use checking conventions and code style default 
integrated in **Pycharm** with command `⌥ ⌘ L` for Mac. PyCharm tries to reformat the source code of the specified scope automatically.
...
Note that code will be checked convention and code style automatically by pylint
therefore you make sure your code will pass the expected rating **<span style="color:red">(7.5/10)</span>**
and if passing the threshold, it is so cool and will be merged to main repository.