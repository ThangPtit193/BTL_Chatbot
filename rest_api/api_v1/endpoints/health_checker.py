...
logging.getLogger("venus_services").setLevel(LOG_LEVEL)
logger = logging.getLogger("venus_services")
...
class HealthResponse(BaseModel):
    version: str = Field(..., description="Venus version")
...
def get_health_status():
    """
    This endpoint allows external systems to monitor the health of the Venus REST API.
    """
    ...
    return HealthResponse(version=rest_api.__version__, cpu=cpu_usage, memory=memory_usage, gpus=gpus)
