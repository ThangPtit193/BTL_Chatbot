...
from typing import Any, Optional, Dict, List, Type, Tuple, Union, Callable
...
from meteor.schema import MultiLabel, Document
from meteor.utils import args_to_kwargs
...
def exportable_to_yaml(init_func):
    ...
    def wrapper_exportable_to_yaml(self, *args, **kwargs):
        ...
        # Call the actually __init__ function with all the arguments
...
class BaseComponent(ABC):
    """
    A base component for implementing nodes in a Pipeline
    """
    ...
    # __init_subclass__ is invoked when a subclass of BaseComponent is _imported_, but not instantiated. It works
    # approximately as a metaclass
