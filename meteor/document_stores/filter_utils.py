...
from meteor.document_stores.utils import convert_date_to_rfc3339
from meteor.errors import FilterError
...
class NotOperation(LogicalFilterClause):
    ...
    #         return conditions[0]
    #
    # def convert_to_pinecone(self) -> Union[Dict[Union[str, Union[str, int, float, bool, List[Dict]]]], Any]:
