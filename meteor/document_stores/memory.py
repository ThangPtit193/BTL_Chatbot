...
from meteor.schema import Document, Label
from meteor.errors import DuplicateDocumentError
...
class InMemoryDocumentStore(BaseDocumentStore):
    ...
    def __init__(
        ...
        :param scoring_batch_size: Batch size of documents to calculate similarity for. Very small batch sizes are inefficient.
                                   ...
                                   Since the data is originally stored in CPU memory there is little risk of over-running memory
                                   when running on CPU.
